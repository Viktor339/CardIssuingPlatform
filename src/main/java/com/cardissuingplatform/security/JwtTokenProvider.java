...
public class JwtTokenProvider {
    ...
    public String createAccessToken(User user) {
        ...
        Date now = new Date();
        Date validity = new Date(now.getTime() + securityProperties.getAccessExpired().toMillis());
    ...
    public String createRefreshToken() {
        ...
        Date now = new Date();
        Date validity = new Date(now.getTime() + securityProperties.getRefreshExpired().toMillis());
