...
@TestPropertySource(locations = "classpath:application.yaml", properties = "cache.enabled = true")
public class UserProviderWithCacheTest extends IntegrationTestBase {
    ...
    public void testGetShouldReturnPage() throws Exception {
        ...
        verify(userRepository, times(1)).findUserById(Mockito.argThat(create -> create.equals(4L)));
